...
import type { FieldValues, UseFormReturn, SubmitHandler, DefaultValues, ArrayPath, UseFieldArrayReturn, UseFormProps } from "react-hook-form";
import type { SchemaConfig } from "./form-utils";
export interface FormProps<T extends FieldValues> {
    children: ReactNode | ((methods: UseFormReturn<T> & {
        submit: () => void;
        isPending: boolean;
